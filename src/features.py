...
# Seuil NIOSH 1998 / Coles et al. 2000 : profondeur d'encoche ≥ 15 dB = NIHL probable
NIHL_NOTCH_THRESHOLD_DB: float = 15.0
# Seuil absolu minimal : le seuil brut à la fréquence de l'encoche doit être ≥ 20 dB HL
...
def compute_nihl_flag(feature_df: pd.DataFrame) -> pd.Series:
    """
